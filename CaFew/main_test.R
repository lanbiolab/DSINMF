...
data_name = 'Haber'
#data <- read.table(file = paste0("C:/Users/MECHREVO/Desktop/test.txt"))
...
write.csv(data2, paste0("E:/single_data/featureSelection1/",data_name,"_data_p_value005.csv"))
write.csv(p_value, paste0("E:/single_data/featureSelection1/",data_name,"_p_value.csv"))
p <- order(p_value)
write.csv(p, paste0("E:/single_data/featureSelection1/",data_name,"_p_value_order.csv"))
#w <- weight[3,1:dim]
write.csv(weight, paste0("E:/single_data/featureSelection1/",data_name,"_weight.csv"))